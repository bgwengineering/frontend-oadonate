...
const CommunityCardImport = ({history}) => {
    ...
    <>
      {allCampaign.length > 0
        ...
        : <div className='spinner-container mx-auto'>
            <h4>No community cause available, please create one</h4>
        </div>}
    </>
  );
};

export default withRouter(CommunityCardImport);
