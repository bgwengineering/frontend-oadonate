...
const StartupCardImport = ({history}) => {
    ...
    <>
      {allCampaign.length > 0
        ...
        : <div className='spinner-container mx-auto'>
          <h4>No Start up cause available, please create one</h4>
        </div>}
    </>
  );
};

export default withRouter(StartupCardImport);
