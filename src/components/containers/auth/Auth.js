...
const AuthLayout = () => {
    ...
    return ( <
        ...
        <div className="auth-container" id="auth-form-container">
         ...
         <div id="lay-hidden">
          <h1>Welcome Back!</h1>
           <p className='auth-p-text'>To keep connected with us please login with your personal info</p>
        ...
        <div className="form-authentication-container sign-up-container">  
          <div className='create-account'>   
            ...
            <span className='soc-span'>or use your email for registration</span>
             <SignupForm />
            </div>
          </div>
        </div>
        ...
        <div className="form-authentication-container sign-in-container">
          <div className='login-details'>
            ...
            <LoginForm />
            <NavLink to='/reset-password' onClick={scrollToTop} className='mt-3 forgot-password'>Forgot your password?</NavLink>  
          </div>
        </div>
        ...
        <div className="overlay-container">
          <div className="overlay">
            ...
            <div className="overlay-panel overlay-right">
              <h1>Hello, Friend!</h1>
              <p className='auth-p-text'>Enter your personal details and start journey with us</p>
